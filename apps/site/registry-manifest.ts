...
export const REGISTRY = [accordion, article, asset_sidebar, badge, button, calendar, card, category_picker, checkbox, chrome, code_block, collapsible_prose, color_swatch, combobox, copy_button, dialog, donut, editor, heatmap, inline_edit, input, login_form, menu, navbar, pfp, prose, rainbow, range, scramble, segmented, select, sheet, showcase, socials, stack, tabs, textarea, theme, tilt, timeline, toc, tooltip, utils];
