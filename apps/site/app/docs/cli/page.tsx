  ...
  return (
    <main className="max-w-2xl mx-auto px-10 py-12 space-y-8 text-sm leading-7 text-white/80">
      ...
      <section>
        ...
        <pre className="border border-white/10 p-4 text-xs my-2">chrome init [--cwd .] [--yes] [--registry &lt;url&gt;]</pre>
        <p>bootstrap chrome in this project. detects pkg manager, framework, tailwind version. writes <code>chrome.json</code>, <code>lib/utils.ts</code>, and patches <code>globals.css</code>.</p>
      </section>
      <section>
        <h2 className="text-lg text-white">add</h2>
        <pre className="border border-white/10 p-4 text-xs my-2">chrome add &lt;name...&gt; [--overwrite] [--yes]</pre>
      ...
      <section>
        ...
        <pre className="border border-white/10 p-4 text-xs my-2">chrome list</pre>
        <p>list available components grouped by type.</p>
      </section>
      <section>
        <h2 className="text-lg text-white">diff</h2>
        <pre className="border border-white/10 p-4 text-xs my-2">chrome diff &lt;name&gt;</pre>
