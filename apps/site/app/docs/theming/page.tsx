export default function Theming() {
  return (
    <main className="max-w-2xl mx-auto px-10 py-12 space-y-6 text-sm leading-7 text-white/80">
      ...
      <p>chrome ships a dark-only theme. <code>init</code> writes a fenced block into your <code>globals.css</code>:</p>
      <pre className="border border-white/10 p-4 text-xs whitespace-pre">{`/* @chrome:theme */
@theme inline {
